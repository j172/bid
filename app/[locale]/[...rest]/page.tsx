...
// notFound() to correctly trigger ../not-found.tsx. This is next-intl's own
// documented fix for this exact gap (see their "Rendering a locale-specific
// 404 page" docs) — see issue #65.
