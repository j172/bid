...
export default async function FaqPage() {
  ...
  return (
    <LegalPageShell title={t("title")} intro={t("intro")} lastUpdated={t("lastUpdated")} notice={t("notice")}>
      {/* No FAQPage JSON-LD here (issue #204's audit): Google retired the
          FAQ rich result on 2026-05-07, confirmed via two independent fetches
          of the changelog dated 2026-05-08 and 2026-06-15 — the feature no
          longer appears in Search results for anyone, not just this site.
