...
// app/[locale]/layout.tsx alongside CookieConsentBanner). #335 replaced a
// broken `~ID` link with a copy-phone-number flow because it believed LINE
// had no public add-friend URL scheme. #355 restores a direct link now that
// a valid LINE official-account ticket URL is available.
