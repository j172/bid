        ...
        <section>
          ...
          <div className="mt-4 flex items-center gap-2.5">
            <a
              ...
              aria-label="Facebook"
              title="翔水鴿舍 Facebook"
              className="flex h-8 w-8 items-center justify-center rounded-full border border-border bg-white text-ink-light transition hover:border-[#1877F2] hover:bg-[#1877F2] hover:text-white hover:shadow-sm"
            >
            ...
            <a
              ...
              aria-label="YouTube"
              title="翔水賽鴿 YouTube"
              className="flex h-8 w-8 items-center justify-center rounded-full border border-border bg-white text-ink-light transition hover:border-red-600 hover:bg-red-600 hover:text-white hover:shadow-sm"
            >
              <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <a
              ...
              aria-label="TikTok"
              title="翔水賽鴿 TikTok"
              className="flex h-8 w-8 items-center justify-center rounded-full border border-border bg-white text-ink-light transition hover:border-black hover:bg-black hover:text-white hover:shadow-sm"
            >
              <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24" aria-hidden="true">
