...
-- 首頁商品輪播用「商品」CMS (issue #277) — see db/init.sql for the fuller
-- header comment. Brand-new tables, whole final schema from day one, same as
-- homepage_videos/pigeon_stations above.
